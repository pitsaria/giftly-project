...
<body>
    ...
    <nav>
        ...
        <ul class="nav-links">
            ...
            <li><a href="company-history.php" class="<?php echo in_array($current_page, ['about.php', 'company-history.php', 'services.php', 'about-app.php', 'developers.php'], true) ? 'active' : ''; ?>">About</a></li>
